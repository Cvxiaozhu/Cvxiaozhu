...
import com.zhu.blog.utils.PathUtils;
import lombok.Data;
...
import static com.zhu.blog.constants.SystemConstants.*;

/**
 * @author GH
 * @Description: 利用七牛云的对象存储功能保存用户个人头像
 * @date 2023/3/4 22:56
 */
@Service
@Data
...
public class UploadServiceImpl implements UploadService {
     ...
     * @return
     */
    private boolean isValid(String originalFilename) {
        return !originalFilename.endsWith(PNG_PICTURE) && !originalFilename.endsWith(JPEG_PICTURE) && !originalFilename.endsWith(JPG_PICTURE);
    }
}
